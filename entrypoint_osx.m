...
//	}
	case NSFlagsChanged:
	{
		...
		ctx.keys[EK_CONTROL] = keys.alpha_shift;
		ctx.keys[EK_SHIFT] = keys.shift;
		ctx.keys[EK_CONTROL] = keys.control;
...
int main(int argc, char * argv[])
{
	...
	return entrypoint(ctx.argc, ctx.argv);
	}
}
